...
curl -fsSL https://raw.githubusercontent.com/AlemanGerman/AutoQueuer/main/css/icon.svg -o "$APP_DIR/css/icon.svg"curl -fsSL https://raw.githubusercontent.com/AlemanGerman/AutoQueuer/main/index.js -o "$APP_DIR/index.js"
